...
def data_loader_tfidf(file):
    ...
    # tfidf_vectorizer_new = TfidfVectorizer(ngram_range=(1, 1), max_features = 47)
...
def model(x_train, x_test, y_train, y_test):
    # Function to train and test the Logistic Regression model
...
def main():
    ...
    # remove commented area above to try with meta-data
    print("Logistic Regression for TF-IDF vectorization: ")
